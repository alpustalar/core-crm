...
import { ClinicTelegramChannelRepositoryModule } from '@modules/channel-config/infrastructure/persistence/mongo/repositories/clinic-telegram-channel/clinic-telegram-channel.repository.module';
