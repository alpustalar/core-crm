...
import { ClinicTelegramChannel } from '@modules/channel-config/domain/entities/clinic-telegram-channel.entity';
import { IClinicTelegramChannelCommandRepository } from '@modules/channel-config/domain/repositories/clinic-telegram-channel.repository';
import { ITelegramBotApi } from '@modules/channel-config/domain/interfaces/telegram-bot-api.interface';
