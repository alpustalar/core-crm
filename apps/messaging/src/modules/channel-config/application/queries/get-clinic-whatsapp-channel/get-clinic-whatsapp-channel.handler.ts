import { whatsappChannelNeedsReauth } from '@modules/channel-config/domain/rules/whatsapp-channel.rules';
...
export class GetClinicWhatsappChannelHandler implements IQueryHandler<
