...
import { MessagingQueueModule } from '@modules/conversation/infrastructure/queue/messaging-queue.module';
import { ChannelRouterModule } from '@modules/conversation/infrastructure/adapters/router/channel-router.module';
import { ContactResolverModule } from '@modules/conversation/infrastructure/adapters/contact/contact-resolver.module';
import { MessagingCacheModule } from '@modules/conversation/infrastructure/cache/messaging-cache.module';
import { AiMemoryCacheModule } from '@modules/ai-agent/infrastructure/cache/ai-memory-cache.module';
