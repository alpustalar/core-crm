...
import { GetTelegramInboundRoutingQuery } from '@modules/channel-config/application/queries/get-telegram-inbound-routing/get-telegram-inbound-routing.query';
import { RequestTelegramContactCommand } from '@modules/channel-config/application/commands/request-telegram-contact/request-telegram-contact.command';
...
import { GetConversationContactStateQuery } from '@modules/conversation/application/queries/get-conversation-contact-state/get-conversation-contact-state.query';
import {
