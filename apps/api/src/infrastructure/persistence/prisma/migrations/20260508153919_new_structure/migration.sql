...
-- CreateEnum
CREATE TYPE "ClinicOperationMode" AS ENUM ('STATIC', 'SHIFT');
...
-- CreateEnum
CREATE TYPE "LedgerSource" AS ENUM ('IYZICO', 'STRIPE', 'CASH', 'BANK_TRANSFER');

-- CreateEnum
CREATE TYPE "LedgerCategory" AS ENUM ('TREATMENT_PAYMENT', 'REFUND', 'MATERIAL_PURCHASE', 'SALARY', 'RENT', 'OTHER');

-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PENDING', 'COMPLETED', 'CANCELLED', 'REFUNDED', 'FAILED');
...
CREATE TABLE "clinics" (
    ...
    "operation_mode" "ClinicOperationMode" NOT NULL DEFAULT 'STATIC',
    "status" "GlobalStatus" NOT NULL DEFAULT 'ACTIVE',
    "timezone" TEXT NOT NULL DEFAULT 'Europe/Istanbul',
    "logo" TEXT,
...
-- CreateIndex
CREATE UNIQUE INDEX "iyzico_transactions_payment_id_key" ON "iyzico_transactions"("payment_id");
...
-- AddForeignKey
ALTER TABLE "iyzico_transactions" ADD CONSTRAINT "iyzico_transactions_payment_id_fkey" FOREIGN KEY ("payment_id") REFERENCES "payments"("id") ON DELETE CASCADE ON UPDATE CASCADE;
