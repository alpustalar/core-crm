...
import { CheckoutFormInitializeRequest, WithIyzicoError } from './iyzico.client';
...
export interface IIyzicoProvider {
  ...
  ): Promise<WithIyzicoError<Iyzipay.CheckoutFormInitialResult & { paymentPageUrl?: string }>>;
  ...
  cancelPayment(input: CancelPaymentInput): Promise<WithIyzicoError<Iyzipay.CancelPaymentResult>>;
