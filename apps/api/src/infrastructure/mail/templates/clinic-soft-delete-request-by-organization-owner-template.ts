...
export const clinicSoftDeleteRequestByOrganizationOwnerTemplate = () => `
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="margin: 0 0 30px; color: #555555; font-size: 16px; line-height: 1.6; text-align: center;">
                Klinik silme talebinizi yetkililere bildirdik.
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 20px 30px; background-color: #f8f9fa; border-top: 1px solid #eeeeee; text-align: center;">
              <p style="margin: 0; color: #999999; font-size: 12px;">
                ...
                Bu maili klinik silme işlemi talebi üzerine aldınız. Talebi siz yapmadıysanız lütfen bu maili siliniz.
              </p>
            </td>
          </tr>
