...
} from '@modules/identity/user/application/commands/update-user-by-staff/update-user-by-staff.response';
    ...
    ICommandHandler<UpdateUserByStaffCommand, UpdateUserByStaffResponse>
{
  ...
  async execute(
    ...
    // Rol değişimi bir yetki işlemidir: kullanıcı kendi rolünü buradan
    // değiştiremez
