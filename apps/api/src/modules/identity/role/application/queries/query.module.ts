...
import { ROLE_REPO } from '@modules/identity/role/domain/repositories/role.repository.interface';
import { RoleRepository } from '@modules/identity/role/infrastructure/persistence/prisma/repositories/role.repository';
