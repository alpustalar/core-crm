...
import { TAX_PARAMETER_COMMAND_REPOSITORY } from '@modules/finance/accounting/tax-parameters/domain/repositories/tax-parameter/tax-parameter.command.repository';
import { TAX_PARAMETER_QUERY_REPOSITORY } from '@modules/finance/accounting/tax-parameters/domain/repositories/tax-parameter/tax-parameter.query.repository';
