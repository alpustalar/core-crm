...
import { IProductBatchQueryRepository } from '@modules/inventory/domain/repositories/product-batch.repository.interface';
import { ProductBatch } from '@modules/inventory/domain/entities/product-batch.entity';

@Injectable()
export class ProductBatchQueryRepository extends BaseRepository implements IProductBatchQueryRepository {
  ...
  async findAvailableByProduct(productId: string, clinicId: string): Promise<ProductBatch[]> {
