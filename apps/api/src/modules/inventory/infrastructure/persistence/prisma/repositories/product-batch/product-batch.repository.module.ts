...
@Module({
  providers: [
    { provide: PRODUCT_BATCH_COMMAND_REPOSITORY, useClass: ProductBatchCommandRepository },
    { provide: PRODUCT_BATCH_QUERY_REPOSITORY, useClass: ProductBatchQueryRepository },
  ],
