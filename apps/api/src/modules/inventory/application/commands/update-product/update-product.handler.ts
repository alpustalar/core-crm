...
export class UpdateProductHandler implements ICommandHandler<UpdateProductCommand, void> {
  ...
  async execute(command: UpdateProductCommand): Promise<void> {
    ...
    product.update({
      ...
      unit: dto.unit,
      vatRate: dto.vatRate != null ? new Prisma.Decimal(dto.vatRate) : undefined,
      criticalStockQty: dto.criticalStockQty != null ? new Prisma.Decimal(dto.criticalStockQty) : undefined,
      reorderQty: dto.reorderQty != null ? new Prisma.Decimal(dto.reorderQty) : undefined,
