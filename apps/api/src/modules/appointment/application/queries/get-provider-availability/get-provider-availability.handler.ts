...
import { GetProviderScheduleQuery } from '@modules/provider/application/queries/get-provider-schedule/get-provider-schedule.query';
import { OperationMode } from '@prisma/client';
import { GetClinicScheduleQuery } from '@modules/clinic/application/queries/get-clinic-schedule/get-clinic-schedule.query';
