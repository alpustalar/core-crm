...
import { GetOrganizationAppointmentsQueryResponse } from '@modules/appointment/application/queries/get-organization-appointments/get-organization-appointments.response';
