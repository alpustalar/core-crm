...
import { IEmployeeContractCommandRepository } from '@modules/hr/employee/domain/repositories/employee-contract/employee-contract.command.repository';
  ...
  implements IEmployeeContractCommandRepository
{
  ...
  async update(entity: EmployeeContract): Promise<EmployeeContract> {
