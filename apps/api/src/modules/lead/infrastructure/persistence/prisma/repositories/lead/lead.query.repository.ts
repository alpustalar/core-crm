...
import { ILeadQueryRepository } from '@modules/lead/domain/repositories/lead.repository.interface';
  ...
  implements ILeadQueryRepository
{
  ...
  async findMany(filter: FindLeadsFilter): Promise<{ items: Lead[]; total: number }> {
