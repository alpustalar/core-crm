...
import { ConfigureClinicAiAgentCommand } from '@modules/messaging/ai-agent/application/commands/configure-clinic-ai-agent/configure-clinic-ai-agent.command';
...
export class AiAgentController {
  ...
  configure(
    ...
    return this.commandBus.execute(
      new ConfigureClinicAiAgentCommand(clinicId, dto, ctx)
    );
  }
  ...
  enable(
    ...
    return this.commandBus.execute(
      new SetClinicAiAgentEnabledCommand(clinicId, true, ctx)
    );
  }
  ...
  disable(
    ...
    return this.commandBus.execute(
      new SetClinicAiAgentEnabledCommand(clinicId, false, ctx)
    );
  }
}
