...
import { FindOrCreatePatientForAuthQueryResponse } from '@modules/crm/patient/application/queries/find-or-create-patient-for-auth/find-or-create-patient-for-auth.response';
