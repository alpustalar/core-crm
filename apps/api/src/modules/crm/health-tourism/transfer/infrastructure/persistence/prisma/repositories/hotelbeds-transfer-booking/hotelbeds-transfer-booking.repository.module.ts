...
import { HOTELBEDS_TRANSFER_BOOKING_COMMAND_REPOSITORY } from '@modules/crm/health-tourism/transfer/domain/repositories/hotelbeds-transfer-booking/hotelbeds-transfer-booking.command.repository';
import { HOTELBEDS_TRANSFER_BOOKING_QUERY_REPOSITORY } from '@modules/crm/health-tourism/transfer/domain/repositories/hotelbeds-transfer-booking/hotelbeds-transfer-booking.query.repository';
