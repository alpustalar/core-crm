...
import { PurchaseRequestCommandRepository } from './purchase-request.command.repository';
import { PurchaseRequestQueryRepository } from './purchase-request.query.repository';
import { PurchaseOrderCommandRepository } from './purchase-order.command.repository';
import { PurchaseOrderQueryRepository } from './purchase-order.query.repository';
...
export class PurchasingRepositoryModule {}
