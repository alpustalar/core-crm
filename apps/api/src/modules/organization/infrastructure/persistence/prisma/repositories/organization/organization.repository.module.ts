...
@Module({
  providers: [
    { provide: ORGANIZATION_COMMAND_REPOSITORY, useClass: OrganizationCommandRepository },
    { provide: ORGANIZATION_QUERY_REPOSITORY, useClass: OrganizationQueryRepository },
  ],
