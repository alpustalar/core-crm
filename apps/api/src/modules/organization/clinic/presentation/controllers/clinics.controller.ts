...
import { RegisterClinicSubMerchantCommand } from '@modules/organization/clinic/application/commands/register-submerchant/register-submerchant.command';
...
export class ClinicController {
  ...
  registerSubMerchant(
    ...
    return this.commandBus.execute(
      new RegisterClinicSubMerchantCommand(id, dto, ctx)
    );
  }
}
