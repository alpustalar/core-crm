...
} from '@modules/provider/infrastructure/persistence/prisma/repositories/provider-availability.repository';
import { PolicyFactory } from '@modules/policy/application/policy-factory';
import {
  ProviderRepositoryModule
} from '@modules/provider/infrastructure/persistence/prisma/repositories/provider/provider.repository.module';
...
} from '@modules/provider/application/queries/provider-can-book-or-throw/provider-can-book-or-throw.handler';
