...
import { IProviderExceptionCommandRepository } from '@modules/clinical/provider/domain/repositories/provider-exception/provider-exception.command.repository.interface';
