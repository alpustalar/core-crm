...
import { PROVIDER_SHIFT_COMMAND_REPOSITORY } from '@modules/clinical/provider/domain/repositories/provider-shift/provider-shift.command.repository.interface';
import { PROVIDER_SHIFT_QUERY_REPOSITORY } from '@modules/clinical/provider/domain/repositories/provider-shift/provider-shift.query.repository.interface';
