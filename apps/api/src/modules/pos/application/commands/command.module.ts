...
import { PosDeviceRepositoryModule } from '@modules/pos/infrastructure/persistence/prisma/repositories/pos-device/pos-device.repository.module';
import { PosTransactionRepositoryModule } from '@modules/pos/infrastructure/persistence/prisma/repositories/pos-transaction/pos-transaction.repository.module';
import { PosProviderModule } from '@modules/pos/infrastructure/providers/pos-provider.module';
