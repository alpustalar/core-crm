...
@Module({
  ...
  providers: [
    { provide: POS_TRANSACTION_COMMAND_REPOSITORY, useClass: PosTransactionCommandRepository },
    { provide: POS_TRANSACTION_QUERY_REPOSITORY, useClass: PosTransactionQueryRepository },
  ],
  exports: [POS_TRANSACTION_COMMAND_REPOSITORY, POS_TRANSACTION_QUERY_REPOSITORY],
})
