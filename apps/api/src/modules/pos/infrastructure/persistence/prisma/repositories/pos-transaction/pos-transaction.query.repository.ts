...
import { IPosTransactionQueryRepository } from '@modules/pos/domain/repositories/pos-transaction.repository';
  ...
  implements IPosTransactionQueryRepository
{
  ...
  async findPendingForReconcile(gracePeriodMs: number): Promise<PendingTransactionForReconcile[]> {
