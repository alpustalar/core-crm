...
import { AssertClinicCanBookOrThrowQuery } from './assert-clinic-can-book-or-throw.query';

@QueryHandler(AssertClinicCanBookOrThrowQuery)
export class AssertClinicCanBookOrThrowHandler
  implements IQueryHandler<AssertClinicCanBookOrThrowQuery, void>
{
  constructor(
  ...
  async execute(query: AssertClinicCanBookOrThrowQuery): Promise<void> {
