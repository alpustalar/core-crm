...
import { CLINIC_AVAILABILITY_DOMAIN_SERVICE } from '@modules/clinic/domain/interfaces/clinic-availability.domain-service.interface';
import { ClinicAvailabilityDomainService } from '@modules/clinic/domain/services/clinic-availability.domain-service';
import { ClinicCanBookOrThrowHandler } from '@modules/clinic/application/queries/clinic-can-book-or-throw/clinic-can-book-or-throw.handler';
...
@Module({
  imports: [ClinicRepositoryModule, ClinicAvailabilityRepositoryModule],
  providers: [
    ...QueryHandlers,
    {
